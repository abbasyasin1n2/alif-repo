...
from database.compliance_queries import (
    ...
    update_food_safety_incident, add_incident_batch, get_incident_batches,
    add_compliance_audit, get_all_compliance_audits, get_compliance_audit_by_id,
    update_compliance_audit, get_compliance_dashboard_stats, generate_incident_number, generate_recall_number
)
from database.recall_queries import (
    ...
    search_batches_for_recall, get_batch_recall_history
)
...
def list_compliance_records():
    ...
    records = get_all_compliance_records(status)
    return render_template('compliance/list_records.html', records=records, current_status=status)
...
def list_food_safety_incidents():
    ...
    incidents = get_all_food_safety_incidents(status)
    return render_template('compliance/list_incidents.html', incidents=incidents, current_status=status)
...
def list_batch_recalls():
    ...
    status = request.args.get('status')
    recalls = get_all_batch_recalls(status)
    return render_template('compliance/list_recalls.html', recalls=recalls, current_status=status)
...
def list_compliance_audits():
    ...
    audits = get_all_compliance_audits()
    return render_template('compliance/list_audits.html', audits=audits)
